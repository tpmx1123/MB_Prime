...
const HomeFAQ = () => {
  ...
  return (
    <section id="faq" className="py-14 md:py-20 bg-[#faf9f6]">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        >
          <span className="inline-block text-secondary font-sans font-bold text-xs uppercase tracking-[0.3em] mb-3">
            Got Questions?
          </span>
          <h2 className="text-2xl md:text-4xl font-sans font-bold text-primary leading-tight mb-4">
            Frequently Asked <span className="italic font-light text-primary/70">Questions</span>
          </h2>
          <div className="w-16 h-1 bg-secondary/50 mx-auto rounded-full" />
        </Motion.div>
        ...
        <p className="text-center text-slate-500 text-sm mt-8 font-sans">
          ...
          <b className="text-secondary font-semibold hover:underline">
            Contact our team
          </b>
        </p>
      </div>
