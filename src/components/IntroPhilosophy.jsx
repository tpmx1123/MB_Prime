        ...
        <div className="flex flex-col lg:flex-row-reverse items-stretch gap-4 sm:gap-6 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col justify-center text-center  lg:text-left lg:items-start">
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-8 max-w-none sm:max-w-xl lg:max-w-md">
              <Motion.p
                className="text-slate-600 text-base sm:text-base md:text-lg lg:text-xl leading-snug sm:leading-relaxed font-sans font-light italic"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              <Motion.p
                className="text-slate-500 text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl leading-snug sm:leading-relaxed font-sans font-light"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
